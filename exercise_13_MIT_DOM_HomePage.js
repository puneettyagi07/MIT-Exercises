...
for (let i = 0; i < capabilityCards.length; i++) {
    ...
    capabilityCards[i].style.border = '1px solid rgba(255, 255, 255, 0.05)';
    ...
    capabilityCards[i].addEventListener('mouseenter', () => {
        ...
        capabilityCards[i].style.backgroundColor = 'rgb(18, 18, 18)';
        capabilityCards[i].style.borderColor = 'skyBlue';
...
for (let i = 0; i < caseStudyCards.length; i++) {
    // Layout: Flexbox pushing elements to bottom-left
    ...
    caseStudyCards[i].style.justifyContent = 'flex-end';
    caseStudyCards[i].style.alignItems = 'flex-start';
    caseStudyCards[i].style.gap = '8px';
    caseStudyCards[i].style.cursor = 'pointer';
...
// Community Section
const communitySectionContainer = document.body.children[1].children[6];
communitySectionContainer.style.width = '100%';
communitySectionContainer.style.height = 'fit-content';
communitySectionContainer.style.backgroundColor = 'rgb(25, 25, 25)';
communitySectionContainer.style.padding = '50px 0px';
communitySectionContainer.style.display = 'flex';
communitySectionContainer.style.flexDirection = 'column';
communitySectionContainer.style.alignItems = 'center';
communitySectionContainer.style.gap = '30px';

const communityHeading = communitySectionContainer.firstElementChild;
communityHeading.style.textAlign = 'center';
communityHeading.style.display = 'flex';
communityHeading.style.flexDirection = 'column';
communityHeading.style.gap = '10px';

const communityheadingChildren = communityHeading.children;
for (let i = 0; i < communityheadingChildren.length; i++) {
    if (i === 0) {
        communityheadingChildren[i].style.fontSize = '10px';
        communityheadingChildren[i].style.fontWeight = '700';
        communityheadingChildren[i].style.color = 'skyBlue';
    } else {
        communityheadingChildren[i].style.fontSize = '26px';
        communityheadingChildren[i].style.fontWeight = '600';
    }
};
const communityCardsContainer = communitySectionContainer.children[1];
